...
Artwork.destroy_all
a1 =  Artwork.create!(favorite_of_artist: false,title: 'Apple of my Eye', artist_id: u3.id, image_url: 'https://images.pexels.com/photos/1103970/pexels-photo-1103970.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
a2 =  Artwork.create!(favorite_of_artist: false,title: 'Pears in Space', artist_id: u3.id, image_url: 'https://images.pexels.com/photos/1114690/pexels-photo-1114690.jpeg?auto=compress&cs=tinysrgb&w=800')
a3 =  Artwork.create!(favorite_of_artist: false,title: 'Hello World', artist_id: u3.id, image_url: 'https://images.pexels.com/photos/844297/pexels-photo-844297.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
a4 =  Artwork.create!(favorite_of_artist: false,title: "Ayce's most amazing Hat", artist_id: u1.id, image_url: 'https://images.pexels.com/photos/1408221/pexels-photo-1408221.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
a5 =  Artwork.create!(favorite_of_artist: true,title: 'Big Cow in the City', artist_id: u2.id, image_url: 'https://images.pexels.com/photos/3660527/pexels-photo-3660527.jpeg?auto=compress&cs=tinysrgb&w=800')
a6 =  Artwork.create!(favorite_of_artist: false,title: 'Death', artist_id: u4.id, image_url: 'https://images.pexels.com/photos/310452/pexels-photo-310452.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
a7 =  Artwork.create!(favorite_of_artist: false,title: 'Where the wild things code', artist_id: u2.id, image_url: 'https://images.pexels.com/photos/1072179/pexels-photo-1072179.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
a8 =  Artwork.create!(favorite_of_artist: false,title: 'Pikachu', artist_id: u1.id, image_url: 'https://images.pexels.com/photos/3293148/pexels-photo-3293148.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')
a9 = Artwork.create!(favorite_of_artist: true,title: 'My Kin Ka fan fiction', artist_id: u4.id, image_url: 'https://images.pexels.com/photos/15286/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=800')
a10 = Artwork.create!(favorite_of_artist: true,title: 'Garbage', artist_id: u5.id, image_url: 'https://images.pexels.com/photos/3745234/pexels-photo-3745234.jpeg')
artworks_arr = [a1, a2, a3, a4, a5, a6, a7, a8, a9, a10]

ArtworkShare.destroy_all
u1a1 = ArtworkShare.create!(viewer_id: u1.id, artwork_id: a1.id, favorite_of_sharer: false)
u1a2 = ArtworkShare.create!(viewer_id: u1.id, artwork_id: a2.id, favorite_of_sharer: false)
u1a3 = ArtworkShare.create!(viewer_id: u1.id, artwork_id: a3.id, favorite_of_sharer: false)
u1a4 = ArtworkShare.create!(viewer_id: u1.id, artwork_id: a4.id, favorite_of_sharer: false)
u2a1 = ArtworkShare.create!(viewer_id: u2.id, artwork_id: a1.id, favorite_of_sharer: false)
u2a2 = ArtworkShare.create!(viewer_id: u2.id, artwork_id: a2.id, favorite_of_sharer: false)
u2a3 = ArtworkShare.create!(viewer_id: u2.id, artwork_id: a3.id, favorite_of_sharer: false)
u2a4 = ArtworkShare.create!(viewer_id: u2.id, artwork_id: a4.id, favorite_of_sharer: false)
u3a1 = ArtworkShare.create!(viewer_id: u3.id, artwork_id: a1.id, favorite_of_sharer: true)
u3a2 = ArtworkShare.create!(viewer_id: u3.id, artwork_id: a2.id, favorite_of_sharer: false)
u3a3 = ArtworkShare.create!(viewer_id: u3.id, artwork_id: a3.id, favorite_of_sharer: false)
u3a4 = ArtworkShare.create!(viewer_id: u3.id, artwork_id: a4.id, favorite_of_sharer: true)
u4a1 = ArtworkShare.create!(viewer_id: u4.id, artwork_id: a1.id, favorite_of_sharer: false)
u4a2 = ArtworkShare.create!(viewer_id: u4.id, artwork_id: a2.id, favorite_of_sharer: false)
u4a3 = ArtworkShare.create!(viewer_id: u4.id, artwork_id: a3.id, favorite_of_sharer: true)
u4a4 = ArtworkShare.create!(viewer_id: u4.id, artwork_id: a4.id, favorite_of_sharer: true)
u5a1 = ArtworkShare.create!(viewer_id: u5.id, artwork_id: a1.id, favorite_of_sharer: true)
u5a2 = ArtworkShare.create!(viewer_id: u5.id, artwork_id: a2.id, favorite_of_sharer: true)
u5a3 = ArtworkShare.create!(viewer_id: u5.id, artwork_id: a3.id, favorite_of_sharer: false)
u5a4 = ArtworkShare.create!(viewer_id: u5.id, artwork_id: a4.id, favorite_of_sharer: false)
